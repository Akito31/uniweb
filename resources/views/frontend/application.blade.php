                ...
                <div class="col col-lg-8 offset-lg-2">
                    <form action="">
                        <div class="card p-3">
                            ...
                            <hr>
                            <div class="px-3">
                            <h3 class="mt-3">Application for University</h3>
                            ...
                            <div class="my-3 px-3">
                                ...
                                <div class="my-3 text-center">
                                    <!-- <a href="" class="text-primary small text-decoration-none">For Scholarship Application?</a> -->
                                     <p class="small text-muted">For Scholarship Application, you need to apply first in order to get the application.</p>
